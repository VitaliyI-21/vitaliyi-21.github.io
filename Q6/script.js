...
hintButton.addEventListener('click', () => {
  ...
  if (!hintText) {
    ...
    hintText.textContent = 'Підсказка: створи тег <a> з href="https://csslearner.dev" і відповідним текстом.';
...
checkButton.addEventListener('click', () => {
  ...
  const a = doc.querySelector('a[href="https://google.com"]');

  if (a && a.textContent.trim().toLowerCase() === 'перейти до пошуку') {
    ...
    if (!nextBtn) {
      ...
      nextBtn.addEventListener('click', () => {
        ...
        if (match) {
          ...
          window.location.href = '../Q7/Q7.html';
        }
      });
    }
  } else {
